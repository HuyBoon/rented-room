        ...
        <Card className="p-2 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base md:text-2xl font-bold">{stats.totalRooms}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                {stats.rentedRooms} đang thuê
              </p>
            </div>
        ...
        <Card className="p-2 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base md:text-2xl font-bold text-green-600">{stats.availableRooms}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                {((stats.availableRooms / stats.totalRooms) * 100).toFixed(1)}% tổng
              </p>
            </div>
        ...
        <Card className="p-2 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base md:text-2xl font-bold">{formatCurrency(stats.monthlyRevenue)}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                +12% tháng trước
              </p>
            </div>
        ...
        <Card className="p-2 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base md:text-2xl font-bold text-red-600">{stats.pendingIssues}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                Cần xử lý
              </p>
            </div>
        ...
        <Card className="p-3 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg md:text-2xl font-bold text-orange-600">{stats.overdueInvoices}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                Cần theo dõi
              </p>
            </div>
        ...
        <Card className="p-3 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg md:text-2xl font-bold text-yellow-600">{stats.expiringContracts}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                Cần gia hạn
              </p>
            </div>
        ...
        <Card className="p-3 md:p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg md:text-2xl font-bold">{formatCurrency(stats.yearlyRevenue)}</p>
              <p className="text-[8px] md:text-xs text-gray-500">
                Tổng doanh thu
              </p>
            </div>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs md:text-sm font-medium">{stats.availableRooms}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs md:text-sm font-medium">{stats.rentedRooms}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs md:text-sm font-medium">{stats.maintenanceRooms}</span>
              </div>
              
              <div className="pt-2 border-t">
                <div className="flex items-center justify-between">
                  <span className="text-xs md:text-sm font-medium">Tổng cộng</span>
                  <span className="text-xs md:text-sm font-medium">{stats.totalRooms}</span>
                </div>
              </div>
            </div>
          </CardContent>
