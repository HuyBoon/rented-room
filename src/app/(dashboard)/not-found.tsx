        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
              <Link href="/dashboard/rooms" className="text-blue-600 hover:underline">
                Quản lý phòng
              </Link>
              ...
              <Link href="/dashboard/contracts" className="text-blue-600 hover:underline">
                Hợp đồng
              </Link>
              ...
              <Link href="/dashboard/buildings" className="text-blue-600 hover:underline">
                Tòa nhà
              </Link>
              <Link href="/dashboard/notifications" className="text-blue-600 hover:underline">
                Thông báo
              </Link>
            </div>
          </CardContent>
